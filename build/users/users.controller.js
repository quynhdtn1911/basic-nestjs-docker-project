...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.getListUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.getListUsers()];
                    case 1:
                        users = _a.sent();
    ...
    UsersController.prototype.createUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.createUser(user)];
                    case 1:
                        newUser = _a.sent();
    ...
    UsersController.prototype.updateUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var newUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.updateUser(user)];
                    case 1:
                        newUser = _a.sent();
                        return [2 /*return*/, newUser];
                }
