...
var RoleService = /** @class */ (function () {
    function RoleService() {
        this.repository = index_1.default.getRepository(Role_1.Role);
    }
    RoleService.prototype.getListRole = function () {
        var roles = this.repository.find();
        return new Promise(function (resolve) {
            resolve(roles);
        });
    };
    RoleService.prototype.getRole = function (id) {
        var role = this.repository.find({
            where: {
                id: Number(id)
            }
        });
    ...
    RoleService.prototype.createRole = function (role) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.save(role)];
                    case 1:
                        newRole = _a.sent();
